...
function renderSettings(){
  ...
  document.getElementById('settingsScreen').innerHTML=`
    ...
    <div class="anbody">
      ...
      <div class="tiny muted" style="text-align:center;margin-top:22px;">ASCEND prototype · v0.19 · ${window.cloud&&cloud.ready()?'synced to your account':'data stored on this device'}</div>
    </div>`;
}
